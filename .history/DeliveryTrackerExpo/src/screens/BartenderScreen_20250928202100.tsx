...
export default function BartenderScreen() {
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            ...
            <View style={styles.settingsSection}>
              ...
              <TouchableOpacity 
                style={[styles.venueButton, { backgroundColor: '#8E8E93' }]} 
                disabled={true}
              >
                <Text style={styles.venueButtonText}>🏗️ Map Building Layout (Coming Soon)</Text>
              </TouchableOpacity>
              <Text style={styles.infoText}>
                3D venue mapping temporarily disabled. Will be available in the next update.
              </Text>
            </View>
      ...
      {/* Venue Management Modal - Temporarily Disabled */}
      {/* 
      <Modal
        animationType="slide"
        transparent={false}
