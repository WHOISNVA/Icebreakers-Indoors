...
// Defer heavy 3D/Venue stack until modal opens to avoid startup crashes
// eslint-disable-next-line @typescript-eslint/no-var-requires
let VenueManagementScreenLazy: any = null;
...
export default function BartenderScreen() {
  ...
  const [venueManagementVisible, setVenueManagementVisible] = useState(false);
  ...
  return (
    <View style={styles.container}>
            ...
            <View style={styles.settingsSection}>
              ...
              <TouchableOpacity 
                ...
                onPress={() => {
                  ...
                  // Lazy load the screen to delay Three/Fiber initialization
                  if (!VenueManagementScreenLazy) {
                    VenueManagementScreenLazy = require('./VenueManagementScreen').default;
                  }
                  setVenueManagementVisible(true);
                }}
              >
                <Text style={styles.venueButtonText}>🏗️ Map Building Layout</Text>
              </TouchableOpacity>
              <Text style={styles.infoText}>
                Create 3D venue models, set zones, and configure AR indoor positioning for precise delivery tracking.
              </Text>
            </View>
      ...
      <Modal
        animationType="slide"
        transparent={false}
        visible={venueManagementVisible}
        onRequestClose={() => setVenueManagementVisible(false)}
      >
        <View style={styles.venueModalContainer}>
          <View style={styles.venueModalHeader}>
            <TouchableOpacity onPress={() => setVenueManagementVisible(false)}>
              <Text style={styles.backButton}>← Back</Text>
            </TouchableOpacity>
            <Text style={styles.venueModalTitle}>Venue Management</Text>
            <View style={{ width: 60 }} />
          </View>
          {VenueManagementScreenLazy ? <VenueManagementScreenLazy /> : null}
        </View>
      </Modal>
