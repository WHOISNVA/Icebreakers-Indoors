        ...
        <View style={styles.info}>
          ...
          {order.locationDescription && (
            <View style={styles.descriptionContainer}>
              ...
              <Text style={styles.descriptionText}>{order.locationDescription}</Text>
            </View>
          )}
          
          {order.currentLocationDescription && (
            <View style={styles.descriptionContainer}>
              <Text style={styles.descriptionLabel}>📍 Updated Location:</Text>
              <Text style={styles.descriptionText}>{order.currentLocationDescription}</Text>
            </View>
          )}
